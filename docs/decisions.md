...
**Revisit if:** Participant count grows enough that within-run counterbalancing across several runs becomes affordable, at which point recall can be varied within a run without the identity confound.
